...
const buttonVariants = cva(
  // Same WCAG AA focus-contrast fix as input.tsx (see its comment):
  // `outline-none` fully disables globals.css's opaque `:focus-visible`
  // outline, so `ring-ring/50` (deterministically 50% alpha via Tailwind's
  // own compiled cascade order) was the only indicator and measured
  // 2.06:1 — bumped to full-opacity `ring-ring` (4.99:1).
